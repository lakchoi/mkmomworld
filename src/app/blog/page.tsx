...
export default function BlogPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      <div className="mb-10">
        <p className="text-orange-400 font-semibold text-sm mb-2">📝 이야기 나누기</p>
      ...
      <div className="flex items-center justify-center py-20 flex-col gap-4">
        ...
        <Link
          href="/"
          className="mt-4 px-6 py-2.5 rounded-full bg-orange-400 text-white font-semibold hover:bg-orange-500 transition-colors text-sm"
        >
          홈으로 돌아가기
        </Link>
      </div>
