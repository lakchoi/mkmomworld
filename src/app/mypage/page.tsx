...
export default function MyPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      {/* Profile header */}
      <div className="bg-gradient-to-br from-orange-400 to-pink-500 rounded-3xl p-6 md:p-8 text-white mb-6">
        ...
        <div className="mt-6">
          <div className="flex items-center justify-between mb-2">
            <p className="text-xs text-white/70">등급 현황</p>
          </div>
              ...
              return (
                <div
                  ...
                  className={`flex-1 h-2 rounded-full ${
                    i <= currentGradeIndex ? "bg-white" : "bg-white/20"
                  }`}
                />
              );
            })}
          ...
          <div className="flex items-center justify-between mt-1.5">
            <span className="text-xs text-white/70">🌱 씨앗</span>
            <span className="text-xs text-white/70">🌲 숲</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-orange-50">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-bold text-orange-500">{gradeInfo.pointRate}%</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-orange-50">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-gradient-to-r from-orange-400 to-pink-500 text-white font-semibold text-sm hover:shadow-lg hover:shadow-orange-300/50 transition-all"
          >
        ...
        {/* Grade list */}
        <div className="md:col-span-2 bg-white rounded-3xl p-6 shadow-sm border border-orange-50">
          <h2 className="font-bold text-stone-800 mb-4 flex items-center gap-2">
              ...
              return (
                <div
                  ...
                  className={`relative p-4 rounded-2xl text-center border-2 transition-all ${
                    isCurrent
                      ? `${gi.bgColor} border-orange-300 shadow-md`
                      : isCurrentOrPast
                ...
                >
                  {isCurrent && (
                    <div className="absolute -top-2 left-1/2 -translate-x-1/2 bg-orange-400 text-white text-xs px-2 py-0.5 rounded-full font-bold">
                      현재
                    </div>
                  )}
